<?php 
/*
	Template Name: 2 Col Portfolio Sidebar
 */
get_header(); ?>
		<style type="text/css">
			.item {
			...
			<main id="main" class="site-main" role="main">
				...
				?>
					<li class="item <?php echo $skills; ?>">
						...
						<div class="portfolio2col_sidebar">
						<?php
						...
						?>
							<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'portfolio2col_sidebar' ); ?></a>
							<div class="portfolio2col_sidebar_overlay" style="display: none;">
							...
							</div><!-- .portfolio2col_sidebar_overlay -->

						</div><!-- .portfolio2col_sidebar -->
