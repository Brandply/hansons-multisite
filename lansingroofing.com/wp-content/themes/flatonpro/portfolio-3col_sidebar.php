<?php 
/*
	Template Name: 3 Col Portfolio Sidebar
 */
get_header(); ?>
		<style type="text/css">
			.item {
		...
		<main id="main" class="site-main" role="main">
			...
			?>
				<li class="item <?php echo $skills; ?>">
					...
					<div class="portfolio3col_sidebar">
					<?php
					...
					?>
						<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'portfolio3col_sidebar' ); ?></a>
						<div class="portfolio3col_sidebar_overlay" style="display: none;">
							<div class="overlay_icon" style="left: -42%;">
							<?php if( $portfolio_video_type != 'none' && $portfolio_video_id != '' ) :  ?>
						
								<?php if( $portfolio_video_type == 'vimeo' ) : ?>
									<a href="http://vimeo.com/<?php echo $portfolio_video_id; ?>" rel="prettyPhoto"><img src="<?php echo get_template_directory_uri() . '/images/icon-zoom.png'; ?>" alt="<?php the_title(); ?>"></a>
								<?php else : ?>
									<a href="http://www.youtube.com/watch?v=<?php echo $portfolio_video_id; ?>" rel="prettyPhoto"><img src="<?php echo get_template_directory_uri() . '/images/icon-zoom.png'; ?>" alt="<?php the_title(); ?>"></a>
								<?php endif;  ?>

							<?php	else : ?>
								<?php
									$url = wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); ?>
									<a href="<?php echo $url; ?>" rel="prettyPhoto[elasti]"><img src="<?php echo get_template_directory_uri() . '/images/icon-zoom.png'; ?>" alt="<?php the_title(); ?>"></a>
							<?php endif; ?>
									<a href="<?php the_permalink(); ?>" title="<?php the_title( ); ?>"><img src="<?php echo get_template_directory_uri() . '/images/icon-link.png'; ?>" alt=""></a>
							</div>
						</div><!-- .portfolio3col_sidebar_overlay -->

					</div><!-- .portfolio3col_sidebar -->
