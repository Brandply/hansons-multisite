<?php 
/*
	Template Name: 2 Col Portfolio Text
 */
get_header(); ?>
		<style type="text/css">
			.item {
			...
			<ul id="portfolio">
				...
				<li class="item <?php echo $skills; ?>">
					...
					<div class="portfolio2col">
						...
						?>
						<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'portfolio2col' ); ?></a>

						<div class="portfolio2col_overlay" style="display: none;">
